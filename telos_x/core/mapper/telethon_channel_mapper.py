...
class TelethonChannelEntityMapper:
    ...
    def to_database_dict(entity: Union[Chat, Channel, User], target_phone_numer: str) -> Dict:
        """Map Telethon Entity to telos-x Dict to Insert into DB."""
        # Build Model
    ...
    def __map_channel(entity: Channel) -> Dict:
        """Map Telethon Channel to telos-x Dict to Insert into DB."""
        return {
    ...
    def __map_chat(entity: Chat) -> Dict:
        """Map Telethon Chat to telos-x Dict to Insert into DB."""
        return {
            'gigagroup': False,
            'has_geo': False,
            'participants_count': entity.participants_count if entity.participants_count else 0,
    ...
    def __map_user(entity: User) -> Dict:
        """Map Telethon User to telos-x Dict to Insert into DB."""
        return {
            'gigagroup': False,
            'has_geo': False,
